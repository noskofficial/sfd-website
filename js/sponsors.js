document.addEventListener("DOMContentLoaded", async () => {
    ...
    data.forEach(sponsor => {
        spCards += `<a target="_blank" href="${sponsor.link}" class="w-full h-full min-h-48 bg-white px-4 py-8 flex justify-center items-center rounded-lg">
    ...
    sponsorContainer.className = "w-full h-fit grid gap-5 lg:gap-10 py-5 justify-items-center grid-cols-1 items-center " + gridCols;
