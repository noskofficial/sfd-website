    ...
    <div id="members-card" class="relative w-72 rounded-3xl shadow-lg overflow-hidden">
                ...
                <div class="absolute text-center bottom-0 left-0 w-full bg-black bg-opacity-60 text-white p-4">
                    ...
                    <div class="flex justify-center gap-4 mt-4">
                        <a href="${member.socialLinks.instagram}" class="bg-white rounded-full border-4 flex items-center justify-center w-8 h-8 ${member.socialLinks.instagram == "#" ? "hover:cursor-not-allowed" : ""}" target="_blank">
                        ...
                        <a href="${member.socialLinks.facebook}" class="bg-white rounded-full border-4 flex items-center justify-center w-8 h-8 ${member.socialLinks.facebook == "#" ? "hover:cursor-not-allowed" : ""}" target="_blank">
                        ...
                        <a href="${member.socialLinks.linkedin}" class="bg-white rounded-full border-4 flex items-center justify-center w-8 h-8 ${member.socialLinks.linkedin == "#" ? "hover:cursor-not-allowed" : ""}" target="_blank">
                        ...
                        <a href="${member.socialLinks.github}" class="bg-white rounded-full border-4 flex items-center justify-center w-8 h-8 ${member.socialLinks.github == "#" ? "hover:cursor-not-allowed" : ""}" target="_blank">
                        ...
                        <a href="${member.socialLinks.website}" class="bg-white rounded-full border-4 flex items-center justify-center w-8 h-8 ${member.socialLinks.website == "#" ? "hover:cursor-not-allowed" : ""}" target="_blank">
