...
const navCode = `
<nav class="flex z-50 drop-shadow-lg lg:drop-shadow-none flex-row fixed top-0 lg:relative w-full p-8 lg:p-0 bg-[#f6f6ff] lg:bg-transparent lg:mb-4 items-center h-14 justify-between lg:px-[7.5%] xl:px-[10%] lg:mt-7 md:h-[4.75rem]">
    <a href="/"><img class="h-11 md:h-[4.75rem] lg:w-auto lg:hover:cursor-pointer" src="https://raw.githubusercontent.com/noskofficial/sfd-resources/refs/heads/sfd-2024/nosk-sfd-2024/assets/shared/nosk_sfd.svg"
        ...
        <span class="group/about" id="about">
            ...
            <div id="about-menu"
                ...
                <ul class="py-1" aria-labelledby="dropdownLargeButton">
                    ...
                    <li>
                        <!-- <a href="/pages/speakers.html" class="lg:text-sm hover:bg-gray-100 block px-8 lg:px-4 py-2">Speakers</a> -->
                    </li>
                    <li>
    ...
    <img id="hamMenu" src="https://raw.githubusercontent.com/noskofficial/sfd-resources/refs/heads/sfd-2024/nosk-sfd-2024/assets/navbar/hamMenu.svg" class="lg:hidden h-8 md:h-14 hover:cursor-pointer"></img>
</nav>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  hamMenu.addEventListener("click", () => {
    ...
    if (
      srcNow ==
      "https://raw.githubusercontent.com/noskofficial/sfd-resources/refs/heads/sfd-2024/nosk-sfd-2024/assets/navbar/hamMenu.svg"
    ) {
      hamMenu.setAttribute(
        "src",
        "https://raw.githubusercontent.com/noskofficial/sfd-resources/refs/heads/sfd-2024/nosk-sfd-2024/assets/navbar/closeMenu.svg",
      );
    } else {
      hamMenu.setAttribute(
        "src",
