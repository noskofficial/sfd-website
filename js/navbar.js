const navCode = `<nav class="flex flex-row mb-4 w-full justify-between px-[1%] md:px-[5%] lg:px-[10%] mt-7 h-[4.75rem]">
    ...
    <div id="navlist"
        ...
        <span class="group/about" id="about">
            ...
            <!-- Dropdown menu -->
            <div
                class="hidden absolute group-hover/about:block bg-white text-base z-10 list-none divide-y divide-gray-100 rounded shadow w-44">
                <ul class="py-1" aria-labelledby="dropdownLargeButton">
                    <li>
                        <a href="/html/about.html" class="text-sm hover:bg-gray-100 block px-4 py-2">About
                            SFD</a>
                    </li>
                    <li>
                        <a href="#" class="text-sm hover:bg-gray-100 block px-4 py-2">About NOSK</a>
                    </li>
                    <li>
        ...
        <span id="itinerary"><a href="/html/itinerary.html">Itinerary</a></span>
        <span id="ourteam"><a href="/html/ourteam.html">Our Team</a></span>
        <span class="group/activities" id="activities">
            ...
            <!-- Dropdown menu -->
            <div
                class="hidden absolute group-hover/activities:block bg-white text-base z-10 list-none divide-y divide-gray-100 rounded shadow w-44">
                <ul class="py-1" aria-labelledby="dropdownLargeButton">
                    <li>
                        <a href="/html/about.html" class="text-sm hover:bg-gray-100 block px-4 py-2">Project Registration</a>
                    </li>
                    <li>
        ...
        <span id="faqs"><a href="/html/faqs.html">FAQs</a></span>
        <span id="contactus"><a href="/html/contactus.html">Contact Us</a></span>
    </div>
</nav>
`
